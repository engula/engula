...
//                     // Pretend that the current node is the leader. If this request is
// successful,                     // subsequent requests can directly use it as the leader,
// otherwise it will be                     // reset in `apply_status`.
